...
2/3 STARTING: GET THE SNAPSHOT TESTS WORKING, CONTINUE CODEX MAC SESSION

- CODEX: Add snapshot tests for the card examples output HTML, is there a way to do this without the full UI?

- How can we reduce complexity? Use web research. Don't delete the old pathways just yet.
